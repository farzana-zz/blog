		...
		<form action="<?php the_permalink(); ?>" id="contactForm" method="post">
			...
			<ol class="forms">
				...
				<li><label for="email">Email</label>
					<input type="email" name="email" id="email" value="<?php if(isset($_POST['email']))  echo $_POST['email'];?>" class="requiredField" />
					<?php if($emailError != '') { ?>
				...
				<li class="buttons"><input type="hidden" name="submitted" id="submitted" value="true" /><input type="submit" value="Email me &raquo" /></li>
			</ol>
		</form>
